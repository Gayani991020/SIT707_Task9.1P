...
public class MathQuestionServiceSeleniumTest {
    ...
    @Before
    public void setUp() {
        System.setProperty("webdriver.chrome.driver", "/Users/gayaniabewickrama/Downloads/chromedriver-mac-x64 2/chromedriver");
    ...
    public void testLogin() {
        ...
        usernameInput.sendKeys("shevin");
        passwordInput.sendKeys("shevin_pass");
        dobInput.sendKeys("1999-09-22");
        submitButton.click();
